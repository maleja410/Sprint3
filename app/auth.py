    ...
    try:
        ...
        if request.method == 'POST':    
            ...
            if not username:
                ...
                flash(error)
                return render_template('auth/register.htlm')
            ...
            content = 'Por favor revise el correo electrónico registrado para activar su cuenta ' + flask.url_for('auth.activate', _external=True) + '?auth=' + number
